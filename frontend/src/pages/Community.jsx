...
function PostCard({ post, onClick }) {
  return (
    <div
      onClick={onClick}
      className="group flex gap-4 bg-white rounded-xl border shadow-sm px-5 py-4
        cursor-pointer transition-all duration-200 hover:-translate-y-[2px] hover:shadow-md"
    >
      {/* 썸네일 (있을 때만) */}
      {post.thumbnailUrl && (
        <img
