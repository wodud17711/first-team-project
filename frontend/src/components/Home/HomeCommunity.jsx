...
useEffect(() => {
  ...
  return (
    <div className='relative'>
      {/* 좌우 버튼 */}
      <button onClick={prev}
              className="text-[40px] text-txtcolor-700 absolute left-0 top-1/2 hover:text-brand-700">
        ‹
      </button>

      <button onClick={next}
              className="text-[40px] text-txtcolor-700 absolute right-0 top-1/2 hover:text-brand-700">
        ›
      </button>
